...
const services = [
  {
    ...
    description: 'Consultoría empresarial gratuita donde estudiantes y profesores ayudan a resolver problemas de negocio en 4 meses.',
    color: 'from-purple-500 to-pink-500',
  },
  {
    icon: <Briefcase className="w-8 h-8" />,
    title: 'Centro de Abordaje',
    description: 'Servicios de consultoría especializados para empresas que necesitan apoyo en áreas especializadas.',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: 'Academia EmprendeLab',
    description: 'Cursos, talleres y programas de formación para entrepreneurs en todas las etapas.',
    color: 'from-orange-500 to-pink-500',
  },
  {
    icon: <Zap className="w-8 h-8" />,
    title: 'SpaceLab Programa',
    description: 'Metodología diseñada para transformar talento en emprendedores exitosos.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-foreground/60 max-w-2xl mx-auto">
            Un ecosistema universitario de innovación que impulsa emprendedores mediante transferencia de conocimiento
            y programas de aceleración.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {services.map((service, index) => (
            ...
            >
              {/* Icon */}
              <div className={`inline-block p-4 rounded-xl bg-gradient-to-br ${service.color} mb-5 text-white group-hover:shadow-2xl transition-all`}>
                {service.icon}
              </div>
