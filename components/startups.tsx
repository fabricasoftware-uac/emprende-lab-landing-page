    ...
    <section id="startups" className="relative py-20 sm:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {startups.map((startup, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div
                  className={`text-4xl p-3 rounded-lg bg-linear-to-br ${startup.color} text-white`}
                >
                  {startup.logo}
                </div>
                <span
                  className={`px-3 py-1 rounded-full text-xs font-semibold bg-linear-to-r ${startup.color} text-white`}
                >
                  {startup.category}
                </span>
              </div>
              ...
              <p className="text-foreground/70 mb-6 grow leading-relaxed">
                {startup.description}
              </p>
        ...
        >
          ...
          <button className="px-10 py-4 rounded-full bg-linear-to-r from-purple-500 to-pink-500 text-white font-semibold hover:shadow-2xl hover:shadow-purple-500/40 transition-all hover:scale-105">
            Solicita tu Espacio
          </button>
        </motion.div>
      </div>
