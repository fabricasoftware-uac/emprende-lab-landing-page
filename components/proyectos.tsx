...
const projects = [
  ...
  },
  {
    ...
    description:
      "Plataforma integral para la gestión y promoción turística de la ciudad blanca, conectando visitantes con experiencias locales únicas de manera amigable.",
    img: "/popayaninn.webp",
