...
export default function Becados({ becados = [], showViewAll }: BecadosProps) {
  ...
  return (
    <section id="becados" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {showViewAll && (
          <div className="flex justify-center mt-12">
            <Link
              href="/becados"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-white/5 border border-purple-500/20 text-purple-200 font-medium text-sm hover:bg-purple-500/10 hover:border-purple-500/40 transition-all group"
            >
              Ver todos los becados
      ...
      <BecadoModal
        becado={selectedBecado}
        onClose={() => setSelectedBecado(null)}
      />
    </section>
  );
}
