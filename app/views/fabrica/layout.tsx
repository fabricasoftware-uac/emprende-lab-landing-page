...
export default function FabricaLayout({ children }: { children: ReactNode }) {
  ...
  // Optional: Check for fabrica role if you want to restrict it further
  // if (session.user.role !== "fabrica" && session.user.role !== "admin") {
  //   return <Unauthorized />;
  // }
